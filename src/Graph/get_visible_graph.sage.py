...
# This file was *autogenerated* from the file workspace/get_visible_graph.sage
...
def visible_faces(polyhedron, projection_vector):
    ...
    for f in polyhedron.faces(_sage_const_2 ):
        dot = projection_vector.dot_product(f.ambient_Hrepresentation()[_sage_const_0 ]._A)
        if  dot > _sage_const_0 :
